...
namespace Courses_MVC.Controllers
{
    public class ExercisesController : Controller
    {
        ...
        //{
        //    var coursesContext = _context.Exercises.Include(e => e.AppUser).Include(e => e.Lesson);
        ...
        public IActionResult UpdateExercise(Exercise exercise)
        {
            ...
            if(ModelState.IsValid)
            {
                ...
                exerUpdate.teacherId = exercise.teacherId;
        ...
        //    ViewData["lessonId"] = new SelectList(_context.Lessons, "lessonId", "content");
        //    return View();
        //}
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<IActionResult> Create([Bind("exerciseId,content,deadline,lessonId,teacherId")] Exercise exercise)
        //{
        //    if (ModelState.IsValid)
        //    {
        ...
        //    }
        //    ViewData["teacherId"] = new SelectList(_context.Users, "Id", "Id", exercise.teacherId);
